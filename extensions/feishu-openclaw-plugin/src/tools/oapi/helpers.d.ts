...
export type { ToolResult, ClientGetter, ToolContext } from "../helpers.js";
...
export type { ApiFn, InvokeFn, InvokeOptions, InvokeByPathOptions, AuthHint, TryInvokeResult, } from "../../core/tool-client.js";
/**
 ...
 * ```
 */
export declare function json(data: unknown): import("./helpers.js").ToolResult;
/**
 * 解析时间字符串为 Unix 时间戳（秒）
 *
 * 支持多种格式：
 ...
 * ```
 */
export declare function formatTimestampToBeijingTime(timestamp: string | number): string;
/**
 * 将时间戳（毫秒）转换为北京时间字符串
 *
 ...
 * ```
 */
export declare function formatTimestampMsToBeijingTime(timestamp: string | number): string;
/**
